...
st.markdown("Upload your resume and get a critique from an AI assistant.")
...
if analyze_button and uploaded_file:
    try:
        ...
        f"""You are an expert resume reviewer with years of experience in HR and recruitment.
